...
if args_namespace.help or (not args_namespace.update \
    ...
    print("\n")
    print("\n")
    print(bcolors.BG_ENDL_TXT+"[ No Spam Detected and Recorded ]"+bcolors.ENDC)
    print("\n")
    print("\n")
    print("\n")
    print(bcolors.BG_ENDL_TXT+"[ All Packets Captured and Verified ]"+bcolors.ENDC)
